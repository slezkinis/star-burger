...
class Order(models.Model):
    ...
    executive_restaurant = models.ForeignKey(Restaurant, verbose_name='Ресторан, который готовит', blank=True, null=True, on_delete=models.CASCADE)
    ...
    called_at = models.DateTimeField('Время звонка менеджера', blank=True, null=True)
...
class OrderElements(models.Model):
    ...
    price = models.DecimalField(verbose_name='Цена', max_digits=5, decimal_places=2, validators=[MinValueValidator(0)], default=0)
